...
$query_kotor = "SELECT * FROM linen_kotor ORDER BY created_at DESC LIMIT 20";
$result_kotor = $conn->query($query_kotor);
?>
...
<head>
  ...
  <style>
    ...
    .content-wrapper { background-color: #fff; border-radius: 8px; padding: 20px; }
  </style>
</head>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header bg-secondary text-white">
              <h5><i class="fas fa-table"></i> Daftar Distribusi Terkirim</h5>
            </div>
            <div class="card-body table-responsive p-0">
              <table class="table table-bordered table-striped m-0">
                ...
                <?php endwhile; else: ?>
                  <tr><td colspan="4" class="text-center">Tidak ada data distribusi.</td></tr>
                <?php endif; ?>
                </tbody>
              </table>
            </div>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-header bg-danger text-white">
              <h5><i class="fas fa-recycle"></i> Daftar Linen Kotor</h5>
            </div>
            <div class="card-body table-responsive p-0">
              <table class="table table-bordered table-striped m-0">
                <thead class="thead-dark">
                ...
                <tbody>
                <?php if ($result_kotor->num_rows > 0):
                  while ($row = $result_kotor->fetch_assoc()): ?>
                    <tr>
                      <td><?= htmlspecialchars($row['created_at']) ?></td>
                      <td><?= htmlspecialchars($row['unit_name']) ?></td>
                      <td><?= htmlspecialchars($row['jenis_linen']) ?></td>
                ...
                <?php endwhile; else: ?>
                  <tr><td colspan="4" class="text-center">Tidak ada data linen kotor.</td></tr>
                <?php endif; ?>
                </tbody>
              </table>
            </div>
