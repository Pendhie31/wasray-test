      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-header bg-warning text-dark">
            <i class="fas fa-dumpster"></i> Statistik Linen Kotor (Bulanan)
          </div>
          <div class="card-body">
...
<script>
  // Bar Chart Permintaan Linen
  const permintaanChart = new Chart(document.getElementById('permintaanChart').getContext('2d'), {
    type: 'bar',
    data: {
  ...
  // Line Chart Permintaan Linen
  const permintaanChart2 = new Chart(document.getElementById('permintaanChart2').getContext('2d'), {
    type: 'line',
    data: {
      labels: <?= json_encode($monthlyLabels) ?>,
      datasets: [{
  ...
  // Bar Chart Linen Kotor
  const kotorChart = new Chart(document.getElementById('kotorChart').getContext('2d'), {
    type: 'bar',
    data: {
